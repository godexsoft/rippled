...
# RPCSPEC_IS_RIPPLED=1 is set here for direct cmake builds; Conan-based builds
# additionally get it from the generated conan_toolchain.cmake.
if(NOT DEFINED RPCSPEC_IS_RIPPLED)
    add_compile_definitions(RPCSPEC_IS_RIPPLED=1)
endif()
